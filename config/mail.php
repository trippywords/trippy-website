...
//        Config::set('mail.host', $smtp->smtp_host);//
//        Config::set('mail.port',$smtp->smtp_port); //
//        Config::set('mail.address', $smtp->from_email);
//        Config::set('mail.name', $smtp->from_name);
//        Config::set('mail.encryption', $smtp->smtp_security);
//        Config::set('mail.username',$smtp->smtp_username);
//        Config::set('mail.password',$smtp->smtp_password);