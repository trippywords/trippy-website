<header class="app-header navbar">
        ...
        <a class="navbar-brand" href="{{ route('admin-panel') }}">
            ...
            <strong><img src="{{ url('/public/assets/image/logo.png') }}" width="170"></strong>
        ...
        <div class="navbar-search">
            ...
            <input type="text" class="navbar-search-input" placeholder="Find User, Blog ..">
                ...
                <div class="dropdown-menu dropdown-menu-right user-menu animated flipInY ">
                    ...
                    <div class="wrap">
                        ...
                        <div class="dw-user-box">
                            ...
                            <div class="u-img">
                                <?php if (Auth::user()->profile_image != null && file_exists(public_path() . '/user_img/' .Auth::user()->profile_image)) { ?>
                                        <img src="{{ asset("/public/user_img/".Auth::user()->profile_image) }}" alt="user">
                                <?php } else { ?>
