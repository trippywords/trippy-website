                  ...
                  <div class="form_section">
                    ...
                    <form method="POST" id="loginForm" action="{{ URL('/login') }}">
                      <div class="login-page-error">
                        <span style="display: none;" class="login-success" id="success_message"><b>Please check your
                            email</b></span>
                        <span style=";display: none;" class="login-danger" id="error_message1">User does not
                          exist</span>
                        <span style=";display: none;" class="login-danger" id="error_message_verify">Please verify your
                          Account</span>
                        <span style="display: none;" class="login-danger" id="error_password_message">Password is
                          wrong</span>
                        <span style="display: none;" class="login-danger" id="error_token_expired">Token is
                          expired</span>
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            <input id="email" type="email"
                              class="form-control login_signup_input {{ $errors->has('email') ? ' is-invalid' : '' }}"
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            <input id="password" type="password"
                              class="form-control login_signup_input {{ $errors->has('password') ? ' is-invalid' : '' }}"
                ...
                <div class="col-md-12 col-sm-12 form_section_grid">
                  <div class="form_section">
                    ...
                    <form id="frmsignup" method="post" action="{{ route('signup') }}">
                      <div class="login-page-error">
                        <span style="display: none;" class="login-success" id="signup_success_message"><b>Signup
                            Successfully, please verify your account.</b></span>
                        <span style="display: none;" class="login-danger" id="error_signup_message"><b>Invalid details
                            Signup</b></span>
                        <span style="display: none;" class="login-danger" id="error_useremail_message"><b>User Email
                            Already Registered</b></span>
                        <span style="display: none;" class="login-danger" id="error_username_message"><b>User Name
                            Already Registered</b></span>
                      </div>
                      <div class="login_signup_form">
                        <div class="form-group">
                          <div class="input-group">
                            <input type="text" class="form-control login_signup_input" id="first_name" name="first_name"
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            <input type="text" class="form-control login_signup_input" id="last_name" name="last_name"
                        ...
                        <div class="form-group signup-email-input">
                          <div class="input-group">
                            <input type="text" class="form-control login_signup_input" id="user_name" name="name"
                          ...
                          <div id="error_user_name" class="error alreadyemail">Username is associated with another user
                          </div>
                        </div>
                        <div class="form-group signup-email-input">
                          <div class="input-group">
                            <input type="email" class="form-control login_signup_input" id="signup_email" name="email"
                          ...
                          <div id="error_signup_email" class="error alreadyemail">Email is associated with another user
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group">
                            <input type="password" class="form-control login_signup_input" id="signup_password"
                  ...
                  <div class="form_section">
                    <form method="POST" id="forgetpassForm" action="{{ URL('/forgetpass') }}">
                      ...
                      <div class="login_signup_form">
                        <div class="form-group">
                          <div class="input-group">
                            <input id="forgetpassemail" type="email" class="form-control login_signup_input"
                              name="forgetpassemail" value="" placeholder="Email">
                            <div class="input-group-btn">
                              <div>
                                <i class="icon-contact"></i>
                              </div>
                      ...
                      <div class="forgot-error">
                        ...
                        <span style="display: none;" class="forgot-success" id="fsuccess_message"><b>Please check your
                            email</b></span>
                        <span style="display: none;" class="forgot-danger" id="ferror_message">User does not
                          exist</span>
                      </div>
                      <div class="button_section">
                        <div class="row">
                ...
                <div class="col-md-12 col-sm-12 form_section_grid">
                  <div class="form_section">
                    <form method="POST" id="resetpassForm" name="resetpassForm" action="{{ URL('/updatepass') }}">
                      @csrf
                      <span style="color:green;display: none;margin-top: 15px" id="rsuccess_message"><b>Password changed
                          successfully</b></span>
                      <span style="color:red;display: none;margin-top: 15px" id="rerror_message">Verification code not
                        match</span>
                      <span style="color:red;display: none;margin-top: 15px" id="rerror_message_passmatch">Password not
                        match</span>
                      <div class="login_signup_form reset_form">
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <input id="newpassword" type="password" class="form-control login_signup_input"
                              name="newpassword" required autofocus placeholder="New Password">
                            <div class="input-group-btn">
                              <div>
                                <i class="icon-locked"></i>
                              </div>
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            <input id="confirmpassword" type="password" class="form-control login_signup_input"
                              name="confirmpassword" required autofocus placeholder="Confirm Password">
                            <div class="input-group-btn">
                              <div>
                                <i class="icon-locked"></i>
                              </div>
