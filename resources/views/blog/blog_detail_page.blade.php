									...
									<li class="blog_category_list">
										<div class="media">
											<div class="media-left">
												<a target="_blank" href="{{ url("blog/".$recentblog->blog_slug) }}" class="media-heading" title="">
													<?php if (isset($recentblog->blog_image) && $recentblog->blog_image != null && file_exists(public_path() . '/blog_img/' . $recentblog->blog_image)) { ?>
														<img src="{{ asset("/public/blog_img/".$recentblog->blog_image) }}" alt="Blog">
													<?php } else { ?>
